...
import 'package:toast_with_icon/toast_with_icon.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              onPressed: () {
                ToastWithIcon.toast(context,
                    gravity: ToastWithIconGravity.CENTER,
                    elevation: 1.0,
                    icon: 'static/image/success.png',
                    msg: 'iconToast on center');
              },
            ...
            RaisedButton(
              onPressed: () {
                ToastWithIcon.toast(context,
                    gravity: ToastWithIconGravity.BOTTOM,
                    icon: 'static/image/success.png',
                    msg: 'iconToast on bottom');
              },
